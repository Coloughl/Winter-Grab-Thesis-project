...
eems <- eem_read("~/Research/EEMS R Code/REU/Trimmed EEMs", import_function = "aqualog")
...
absorbance_path = ("~/Research/EEMS R Code/REU/A_ABS")
...
#remove and interpolate raman scattering (Original scatter width = c(10, 5))
eems = eem_rem_scat(eems, remove_scatter = c(T,T,F,F), remove_scatter_width = c(10,10,0,0),
                    interpolation = F)

#remove rayleigh scattering
eems = eem_rem_scat(eems, remove_scatter = c(F,F,T,T) , remove_scatter_width = c(0,0,10,10),
                    interpolation = F)
